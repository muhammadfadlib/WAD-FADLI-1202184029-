                ...
                <div class="p-5">
                    <form method="post" action="mybooking.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="date" class="form-control" id="inputDate" placeholder="dd/mm/yyyy"
                                    name="inputDate" value="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="inputPhone" placeholder="Nomor Telpon"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button href="mybooking.php" type="submit" name="submit" id="btn-submit"
                                    class="btn btn-primary btn-block">Book</button>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 kanan px-2">
                <div class="container">
                    <div class="img-card">
                        <?php
                        if (empty($_GET['img'])) {
                            echo '<img  src="std.jpg" alt="">';
                        } else {
                            echo '<img src="./' . $_GET['img'] . '" alt="">';
                        }
                        ?>
                    </div>
